    ...
    >
      ...
      >
        ...
        <View style={styles.form}>
          <View style={styles.field}>
            ...
            <TextInput
              ...
              onChangeText={(v) => setField("workEmail", v)}
              autoCapitalize="none"
              autoComplete="email"
            ...
            />
            {errors.workEmail && <Text style={styles.errorText}>{errors.workEmail}</Text>}
          </View>
        ...
        <Text style={styles.terms}>
          By signing up, you agree to our Terms of use and Privacy policy. We never
